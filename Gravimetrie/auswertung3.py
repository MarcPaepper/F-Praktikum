...
def auswertung(slopeDrift):
	...
	colors = [[0.0, (255/255, 252/255, 205/255)],
			[0.007, (255/255, 237/255, 165/255)],
			[0.02, (255/255, 180/255, 119/255)],
			[0.04, (255/255, 56/255, 92/255)],
			[0.125, (182/255, 54/255, 121/255)],
			[0.25, (127/255, 36/255, 129/255)],
			[0.5, (42/255, 17/255, 92/255)],
			[1.0, (0, 0, 0)]]
	...
	startDepth = 100 # 
	stepSizeDepth = 2 # divisible 50
	maxDepth = 300 # 

	startDensity = 2000 # 
	stepSizeDensity = 10 # divisible 200
	maxDensity = 3000 # 
	...
	heatmap = sns.heatmap(fitnesses, xticklabels=xlabels, yticklabels=ylabels, cmap=cmap, cbar_kws={"label":"X²"}) #, norm=matplotlib.colors.LogNorm()
	...
	plot.figure(figsize=(7.5, 6), dpi=100)
	heatmap = sns.heatmap(fitnesses, xticklabels=xlabels, yticklabels=ylabels, cmap=cmap, cbar_kws={"label":"X²"})
